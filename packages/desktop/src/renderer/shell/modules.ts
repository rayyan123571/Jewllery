...
export const MODULES: readonly ModuleDefinition[] = [
  ...
  { id: 'purchase', label: 'Purchase', builtIn: null, inTopBar: true, icon: 'purchase', group: 'SALES' },
  { id: 'stock', label: 'Stock Management', builtIn: null, inTopBar: true, icon: 'stock', group: 'INVENTORY' },
